...
union()
{
translate([0,0,-bt])rotate([0,0,15])cylinder(h=bt2, d=dc, $fn=12);
...
for (i = [0 : 5]) rotate([0,0,60*i+30]) translate([-w/2,0,t]) cube([w, 100, tt+2]);
    
// mount hole
translate([0,dc/2-7,-bt-1])cylinder(h=bt2+2,d=5,$fn=20);
}
